...
Order lifecycle management (Pending → Paid → Shipped → Completed)
Background job processing for order handling and notifications
Payment simulation with success/failure flows
